"""Build the anonymous paper PDF and copy it to Downloads."""
...
PAPER = ROOT / "paper"
DOWNLOADS_PDF = ROOT.parent / "best-of-n-language-symbolic-planner-hybrids.pdf"
...
def write_result_macros() -> None:
    ...
    symbolic_n1 = summary[(summary["strategy"] == "symbolic_bon") & (summary["n"] == 1)].iloc[0]
    symbolic = at_max.loc["symbolic_bon"]
    simulator = at_max.loc["simulator_bon"]
    calibrated = at_max.loc["calibrated_bon"]
